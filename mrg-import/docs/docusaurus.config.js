...
const config = {
  title: 'MRG Import Tool Specifications',
  tagline: 'Machine Readable Glossary Import Tool',
  ...
  projectName: 'mrg-import', // Usually your repo name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl: 'https://github.com/tno-terminology-design/mrg-import/blob/master/',
  ...
  themeConfig:
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          { to: 'docs/intro',          label: 'MRG Import Tool',      position: 'left'},
          // { to: 'docs/mrg-import/translate-your-site', label: 'Translate Your Site', position: 'left'},
          { href: 'https://github.com/tno-terminology-design/mrg-import', label: 'Github',     position: 'right',
          },
        ],
      },
      footer: {
